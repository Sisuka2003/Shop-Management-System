...
public class update_staff extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(update_staff.class.getName());
   ...
   if(name.equals("") && mob.equals("") && nic.equals("") && job.equals("") && id.equals("")){
        String result= "Staff updating error";    
        fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
        log.debug(result);
        }else{
        String result = adm.staff_update(id,name,mob, nic, job);
        adm.loadStaffTable("", dtm);

        if (result == "Staff updated succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "Staff updating error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
