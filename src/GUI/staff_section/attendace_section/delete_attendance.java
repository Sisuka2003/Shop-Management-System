...
static  Logger log=Logger.getLogger(delete_attendance.class.getName());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Object o3 = jTable1.getValueAt(row, 3);
        String s3 = String.valueOf(o3);
        dateField.setText(s3);

        Object o4 = jTable1.getValueAt(row, 4);
   ...
   if(id.equals("")){
         String result="attendance deleting error";
                  fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.attendance_delete(id);
        adm.loadAttendanceTable("", dtm);

        if (result == "attendance deleted succesfully") {
             succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "attendance deleting error") {
                   fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
