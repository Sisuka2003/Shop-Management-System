...
import static GUI.staff_section.attendace_section.add_attendance.log;
...
static  Logger log=Logger.getLogger(update_attendance.class.getName());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 340, 620));
        ...
        jTextField2.setBounds(110, 30, 350, 30);
        ...
        jButton1.setBounds(460, 30, 110, 30);
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 720, 600));
  ...
  int row = jTable1.getSelectedRow();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     ...
     if(name.equals("") && date.equals("") && month.equals("")){
       ...
       String result = adm.attendance_update(name, date, id, month);
         String txtDate = new SimpleDateFormat("MM / dd / yyyy", Locale.ENGLISH).format(new Date());
        adm.loadAttendanceTable(txtDate, dtm);
        ...
        } else if (result == "Attendace update Failed") {
                 fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
