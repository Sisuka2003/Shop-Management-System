...
static Logger log=Logger.getLogger(add_attendance.class.getName());
    ...
    private void initComponents() {
        ...
        staffField.setBackground(new java.awt.Color(213, 168, 127));
        staffField.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        staffField.setForeground(new java.awt.Color(255, 255, 255));
        staffField.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        staffField.setOpaque(false);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Present", "Absent", "Late Comer" }));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(staffField, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(staffField, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 340, 600));
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 0, -1, 60));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 760, 60));
        ...
        jTextField2.setBounds(110, 30, 410, 30);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NIC", "FULL NAME", "CHECK IN", "CHECK OUT", "DATE", "STATUS"
            }
        ) {
        ...
        jTextField1.setBounds(110, 30, 410, 30);
        ...
        jButton1.setBounds(520, 30, 110, 30);
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 770, 580));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String status=null;
        String name = staffField.getText();
       ...
       if (date.contains("/ 01 /")) {
        ...
        if(name.equals("") && date.equals("") && month.equals("")){
         String result="attendance adding error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.attendance_register(name, date, status,month);
        if(status != "Absent"){
        String latecomerresult=adm.getCheckInTime(name,date);
         adm.attendance_late_comers(name,date,latecomerresult);
        }
        String txtDate = new SimpleDateFormat("dd / MM / yyyy", Locale.ENGLISH).format(new Date());
        adm.loadAttendanceTable(txtDate, dtm);
        if (result == "attendance added succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "attendance adding error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adm.loadStaffTable(keyword, dtm2);
         jTextField1.setText("Please Enter The Member Name");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      int row = jTable1.getSelectedRow();
        ...
        Object o2 = jTable1.getValueAt(row, 1);
         String result=adm.getStaffID(String.valueOf(o2));
        staffField.setText(result);

        Object o5 = jTable1.getValueAt(row, 5);
        String s5 = String.valueOf(o5);
        dateField.setText(s5);
        
     Object o6 = jTable1.getValueAt(row, 6);
        String s6 = String.valueOf(o6);
        
        if(s6.equals("Present")){
        statusField.setSelectedIndex(0);
        }else if(s6.equals("Absent")){
    ...
    private void jButton6MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseEntered
          jButton6.setBackground(new Color(193,153,111));
        jButton6.setForeground(new Color(255, 255, 255));
    }//GEN-LAST:event_jButton6MouseEntered

    private void jButton6MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseExited
            jButton6.setBackground(new Color(255,246,207));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(name.equals("") && date.equals("")){
         String result="Checking out error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
         String result = adm.check_out_attendance(name, date);
         String result2=adm.attendance_search(name,date);
         adm.update_attendance(name,date,result2);
        String txtDate = new SimpleDateFormat("dd / MM / yyyy", Locale.ENGLISH).format(new Date());
        adm.loadAttendanceTable(txtDate, dtm);
        if (result == "check out success") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "check out error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
