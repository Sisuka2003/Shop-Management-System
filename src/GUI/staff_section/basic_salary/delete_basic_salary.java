 ...
 * @author DELL
 */
public class delete_basic_salary extends javax.swing.JFrame {

static  Logger log=Logger.getLogger(delete_basic_salary.class.getName());
    private DefaultTableModel dtm;
    private DefaultTableModel dtm2;
    basicSalary adm;

    public delete_basic_salary() {
          icon();
        initComponents();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(id.equals("")){
        String result="basic salary delete error";
           fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.salary_delete(id);
        adm.loadSalaryTable("", dtm);

        if (result == "basic salary deleted successfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "basic salary delete error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_basic_salary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_basic_salary().setVisible(true);
            }
        });
    }
