 ...
 * @author DELL
 */
public class add_basic_salary extends javax.swing.JFrame {
  
static  Logger log=Logger.getLogger(add_basic_salary.class.getName());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(amount.equals("") && job.equals("")){
           String result="basic salary added error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.salary_register(amount, job);
        adm.loadSalaryTable("", dtm);

        if (result == "Basic sallary added successfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "basic salary added error") {
             fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_basic_salary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_basic_salary().setVisible(true);
            }
        });
    }
