 ...
 * @author DELL
 */
public class search_basic_salary extends javax.swing.JFrame {

static  Logger log=Logger.getLogger(search_basic_salary.class.getName());
    private DefaultTableModel dtm;
    basicSalary adm;

   public search_basic_salary() {
         icon();
        initComponents();   
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Please Enter The Designation");
        ...
        jTextField2.setBounds(220, 30, 240, 30);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DESIGNATION", "AMOUNT" }));
        ...
        statusField.setBounds(80, 30, 140, 30);
        ...
        jButton3.setBounds(610, 30, 110, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      if(attribute.equals("DESIGNATION")){
        ...
        adm.loadSalaryTableAmount(keyword, dtm);
      }
 ...
 Object o =statusField.getSelectedItem();
      String attribute=String.valueOf(o);
        ...
        jTextField2.setText("Please Enter The Designation Amount");
        jTextField2.setForeground(new Color(153,153,153));
        jTextField2.setCaretColor(new Color(255,255,255));
      }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String reportPath = "C:\\Users\\DELL\\JaspersoftWorkspace\\MyReports\\salary.jrxml";
        ...
        try {
            ...
            GUI.reports.salary r = new GUI.reports.salary(this, rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_basic_salary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_basic_salary().setVisible(true);
            }
        });
    }
