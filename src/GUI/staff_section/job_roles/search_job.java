 ...
 */
package GUI.staff_section.job_roles;
 ...
 * @author DELL
 */
public class search_job extends javax.swing.JFrame {
static Logger log=Logger.getLogger(search_job.class.getName());
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(170, 30, 360, 30);
        ...
        jButton2.setBounds(530, 30, 110, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTextField2.setText("Please Enter The Designation Name");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_job.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_job().setVisible(true);
            }
        });
    }
