...
public class delete_job extends javax.swing.JFrame {
    static Logger log=Logger.getLogger(delete_job.class.getName());
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(nameField, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE)
                    .addComponent(idField, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE)
  ...
  if(id.equals("") && name.equals("")){
           String result="job deleting error";
          fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
  }else{
        String result = adm.job_delete(id);
        adm.loadJobRoleTable("", dtm2);

        if (result == "job deleted succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "job deleting error") {
           fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
