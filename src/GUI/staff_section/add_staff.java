...
public class add_staff extends javax.swing.JFrame {
    static Logger log = Logger.getLogger(add_staff.class.getName());
   ...
   private final DefaultTableModel dtm;
    ...
    private void initComponents() {
        ...
        nicField.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        nicField.setForeground(new java.awt.Color(255, 255, 255));
        nicField.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        nicField.setOpaque(false);
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jLabel10)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(nicField, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 30, 720, 570));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String pswd = mobileField.getText();
        String nic = nicField.getText();
        String job = jobField.getText();

        if(name.equals("") && pswd.equals("") && nic.equals("") && job.equals("")){
        String result= "Staff adding error";    
        fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
        log.debug(result);
        }else{
        String result = adm.staff_register(name, pswd, nic,job);
        adm.loadStaffTable("", dtm);
        if (result == "Staff added succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "Staff adding error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
        log.debug(result);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adm.loadStaffTable(keyword, dtm);
        jTextField1.setText("Please Enter The Member Name");
        jTextField1.setForeground(new Color(153,153,153));
        jTextField1.setCaretColor(new Color(255,255,255));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String result=adm.getJobId( String.valueOf(o5));
