...
public class search_staff extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(search_staff.class.getName());
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(560, 30, 100, 30);
        ...
        jTextField2.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 0, 1, 0, new java.awt.Color(164, 142, 109)));
        ...
        jTextField2.setBounds(170, 30, 240, 30);
        ...
        jButton2.setBounds(410, 30, 100, 30);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NAME", "NIC", "JOB" }));
        ...
        statusField.setBounds(90, 30, 80, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      if(attribute.equals("NAME")){
        ...
        adm.loadStaffTableNIC(value, dtm);
      }else if(attribute.equals("JOB")){
        adm.loadStaffTableJOB(value, dtm);
      }
    ...
    private void statusFieldItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_statusFieldItemStateChanged
      ...
      if(attribute.equals("NAME")){
        ...
        jTextField2.setText("Please Enter The Member NIC");
        jTextField2.setForeground(new Color(153,153,153));
        jTextField2.setCaretColor(new Color(255,255,255));
      }else if(attribute.equals("JOB")){
        jTextField2.setText("Please Enter The Member Designation");
        jTextField2.setForeground(new Color(153,153,153));
        jTextField2.setCaretColor(new Color(255,255,255));
      }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GUI.selectors.attendace_op_selector().setVisible(true);
