...
public class delete_staff extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(delete_staff.class.getName());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id.equals("")) {
            String result = "staff deleting error";
            fails f = new fails(this, true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.staff_delete(id);
            adm.loadStaffTable("", dtm);

            if (result == "staff deleted succesfully") {
                succese suceed = new succese(this, true);
                suceed.setVisible(true);
            } else if (result == "staff deleting error") {
                fails f = new fails(this, true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
