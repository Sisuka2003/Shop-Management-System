...
public class search_customer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Please Enter The Customer First Name");
        ...
        jTextField2.setBounds(230, 30, 310, 30);
        ...
        jButton2.setBounds(540, 30, 110, 30);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FIRST NAME", "LAST NAME", "MOBILE NUMBER" }));
        ...
        statusField.setBounds(90, 30, 140, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(attribute.equals("FIRST NAME")){
            adm.loadCustomerTableFname(keyword, dtm);
        }else if(attribute.equals("LAST NAME")){
            adm.loadCustomerTableLname(keyword, dtm);
        }else if(attribute.equals("MOBILE NUMBER")){
  ...
  Object o =statusField.getSelectedItem();
        ...
        jTextField2.setText("Please Enter The Customer Last Name");
        jTextField2.setForeground(new Color(153,153,153));
        }else if(attribute.equals("MOBILE NUMBER")){
        jTextField2.setText("Please Enter The Customer Mobile Number");
        jTextField2.setForeground(new Color(153,153,153));
        }
