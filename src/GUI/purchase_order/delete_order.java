...
public class delete_order extends javax.swing.JFrame {
    static Logger log = Logger.getLogger(delete_order.class.getName());
...
orderModel adm;
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                            .addGap(28, 28, 28)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(dateFeild, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    String id = idField.getText();
        ...
        if(id.equals("") && date.equals("")){
            String result="order id deleted error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
            String result = adm.orderid_delete(id);
            adm.loadOrderIdTable("", dtm);

            if (result == "order id deleted succesfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "order id deleted error") {
                fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
            log.debug(result);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       GUI.purchase_order.delete_product_order pou= new GUI.purchase_order.delete_product_order();
