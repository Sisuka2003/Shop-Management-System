...
public class add_order extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(add_order.class.getName());
    ...
    private void initComponents() {
        ...
        jButton5.setText("INSERT  EXISTING  PRODUCTS");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id.equals("") && date.equals("")) {
            String result = "order id adding error";
            fails f = new fails(this, true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.orderid_reg(date);
            adm.loadOrderIdTable("", dtm);

            if (result == "order id added succesfully") {
                succese suceed = new succese(this, true);
                suceed.setVisible(true);
            } else if (result == "order id adding error") {
                fails f = new fails(this, true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        GUI.purchase_order.add_products_order poa = new GUI.purchase_order.add_products_order();
        poa.adm.loadOrderTable(keyword, poa.dtm);
        poa.setVisible(true);
