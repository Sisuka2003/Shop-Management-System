 ...
 * @author DELL
 */
public class search_products_order extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(search_products_order.class.getName());
    DefaultTableModel dtm;
    orderModel adm;

    public search_products_order() {
        icon();
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Please Enter The Order Number");
        ...
        jTextField2.setBounds(170, 30, 250, 30);
        ...
        jButton2.setBounds(420, 30, 110, 30);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ORDER DATE", "ORDER ID" }));
        ...
        statusField.setBounds(60, 30, 110, 30);
        ...
        jButton3.setBounds(560, 30, 110, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (attribute.equals("ORDER DATE")) {
            adm.loadOrderIdTable(keyword, dtm);
        } else if (attribute.equals("ORDER ID")) {
            adm.loadOrderIDTableID(keyword, dtm);
        }
    ...
    private void statusFieldItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_statusFieldItemStateChanged
        ...
        if (attribute.equals("ORDER DATE")) {
            ...
            jTextField2.setText("Please Enter The Order ID");
            jTextField2.setForeground(new Color(153, 153, 153));
            jTextField2.setCaretColor(new Color(255, 255, 255));
        }
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        view_related_products vrp = new view_related_products();
        adm.loadOrderedProductViewer2(orderID, vrp.dtm);
        String result2 = adm.loadTotalAmount(orderID, vrp.dtm);
        int count = vrp.ordersLoader.getRowCount();

        String castCount = String.valueOf(count);
        vrp.totalAmountField.setText(result2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String s1 = String.valueOf(o1);
        orderID = s1;
        String reportPath = "C:\\Users\\DELL\\JaspersoftWorkspace\\MyReports\\purchase_order.jrxml";

        Map m = new HashMap();
        m.put("order_no", orderID);
        ...
        try {
            ...
            GUI.reports.po r = new GUI.reports.po(this, rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_products_order.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_products_order().setVisible(true);
            }
        });
    }
