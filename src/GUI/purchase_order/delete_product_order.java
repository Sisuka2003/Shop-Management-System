 ...
 * @author DELL
 */
public class delete_product_order extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(delete_product_order.class.getName());
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(200, 30, 460, 30);
        ...
        jButton1.setBounds(660, 30, 110, 30);
        ...
        jTextField2.setText("Please Enter Product Barcode");
        ...
        jTextField2.setBounds(200, 30, 460, 30);
        ...
        jButton2.setBounds(660, 30, 110, 30);
        ...
        jTextField3.setBounds(200, 40, 460, 30);
        ...
        jButton3.setBounds(660, 40, 110, 30);
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 900, 690));
    ...
    private void jButton5MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseEntered
        jButton5.setBackground(new Color(243, 88, 88));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String oid = poField.getText();
        String id = idField.getText();

        if (oid.equals("")) {
            String result = "order deleting error";
            ...
            String result2 = adm.order_delete(oid);
        adm.loadOrderTable(id, dtm);

            if (result2 == "order deleting succesfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result2 == "order deleting error") {
                fails f = new fails(this,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_product_order.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_product_order().setVisible(true);
            }
        });
    }
