 ...
 * @author DELL
 */
public class waterbill extends javax.swing.JDialog {

    /**
     * Creates new form waterebill
     */
    public waterbill(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                waterbill dialog = new waterbill(new javax.swing.JFrame(), true);
