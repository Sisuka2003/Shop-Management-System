...
public class search_supplier extends javax.swing.JFrame {
    ...
    static Logger log=Logger.getLogger(search_supplier.class.getName());
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(220, 30, 310, 30);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NAME", "MOBILE", "COMPANY" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(attribute.equals("COMPANY")){
            ...
            adm.loadSupplierTableName(keyword, dtm);
        }else if(attribute.equals("MOBILE")){
            adm.loadSupplierTableMobile(keyword, dtm);
        }
    ...
    private void statusFieldItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_statusFieldItemStateChanged
        ...
        jTextField2.setText("Please Enter The Supplier Mobile Number");
        jTextField2.setForeground(new Color(153,153,153));
        jTextField2.setCaretColor(new Color(255,255,255));
        }
