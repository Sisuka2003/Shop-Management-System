 ...
 */
package GUI.supplier_section.company_section;

import GUI.outputs.fail;
import GUI.outputs.fails;
import GUI.outputs.succese;
import GUI.outputs.success;
import static GUI.supplier_section.company_section.add_company.log;
 ...
 * @author DELL
 */
public class delete_company extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(delete_company.class.getName());
    ...
    public delete_company() {
        icon();
        initComponents();
        adm = new companyModel();
        dtm = (DefaultTableModel) jTable1.getModel();
        adm.companyTableLoad("", dtm);
    ...
    private void initComponents() {
        ...
        addressField.setBackground(new java.awt.Color(213, 168, 127));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        adm.companyTableLoad(keyword, dtm);
        jTextField2.setText("Please Enter The Company Name");
        jTextField2.setForeground(new Color(153,153,153));
        jTextField2.setCaretColor(new Color(255,255,255));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (name.equals("") && address.equals("") && contact.equals("")) {
            String result = "company deleted error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.company_delete(id);
            adm.companyTableLoad("", dtm);

            if (result == "company deleted succesfully") {
             succese suceed = new succese(this,true);
            suceed.setVisible(true);
            } else if (result == "company deleted error") {
                fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_company.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_company().setVisible(true);
            }
        });
    }
