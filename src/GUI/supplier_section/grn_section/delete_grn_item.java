...
public class delete_grn_item extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(delete_grn_item.class.getName());
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(categoryFeild, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String resultfirst = adm.getProductId(product_name);
        pid = resultfirst;
        if (pname.equals("") && qty.equals("") && bprice.equals("") && grn_no.equals("") && category.equals("")) {

            String result = "item updated Failed";
            ...
            String result = adm.cancelItem(id,pid);
            ...
            adm.loadCategoryTable("", dtm3);
            adm.loadProductTable("", dtm4);
            if (result.equals("Item cancelled from GRN")) {
                succese suceed = new succese(this, true);
                suceed.setVisible(true);
            } else if (result.equals("Item cancel failed from GRN")) {
                fails f = new fails(this, true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_grn_item.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_grn_item().setVisible(true);
            }
        });
    }
