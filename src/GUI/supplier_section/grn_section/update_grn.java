...
public class update_grn extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(update_grn.class.getName());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (date.equals("") && payment.equals("") && supplier.equals("") && company.equals("")) {
            String result = "GRN updated Failed";
        fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.grn_update(id,date, payment, supplier, company);
            adm.loadGrnTable("", dtm);

            if (result == "GRN updated Successfully") {
                GUI.outputs.succese suceed = new GUI.outputs.succese(this,true);
                suceed.setVisible(true);
            } else if (result == "GRN updated Failed") {
               fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String s2 = adm.getSuppID(String.valueOf(o2));
        supplierField.setText(s2);

        Object o3 = jTable1.getValueAt(row, 2);
        String s3 = adm.getCompanyID(String.valueOf(o3));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_grn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
