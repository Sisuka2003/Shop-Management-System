 ...
 * @author DELL
 */
public class add_grn extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(add_grn.class.getName());
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, 720, 570));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (date.equals("") && payment.equals("") && supplier.equals("") && company.equals("")) {
            String result = "GRN added Failed";
            fails f = new fails(this, true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.grn_register(date, payment, supplier, company);
            adm.loadGrnTable("", dtm);

            if (result == "GRN added Successfully") {
                succese suceed = new succese(this, true);
                suceed.setVisible(true);
            } else if (result == "GRN added Failed") {
                fails f = new fails(this, true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        GUI.supplier_section.grn_section.add_grn_item sgai = new GUI.supplier_section.grn_section.add_grn_item();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_grn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
