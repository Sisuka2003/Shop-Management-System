 ...
 * @author DELL
 */
public class search_stock extends javax.swing.JFrame {
    static Logger log=Logger.getLogger(search_stock.class.getName());
...
stockModel adm;
    ...
    private void initComponents() {
        ...
        jTextField2.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 0, new java.awt.Color(153, 153, 153)));
        ...
        jTextField2.setBounds(80, 30, 360, 30);
        ...
        jButton2.setBounds(440, 30, 110, 30);
        ...
        jButton3.setBounds(580, 30, 110, 30);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       String reportPath = "C:\\Users\\DELL\\JaspersoftWorkspace\\MyReports\\stocks.jrxml";
        ...
        try {
            ...
            GUI.reports.stocks r = new GUI.reports.stocks(this, rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_stock().setVisible(true);
            }
        });
    }
