...
public class update_product extends javax.swing.JFrame {
    static Logger log=Logger.getLogger(update_product.class.getName());
...
productModel adm;
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, -1, 60));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 740, 60));
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 750, 580));
...
if (id.equals("") && name.equals("") && sell.equals("") && qty.equals("") && category.equals("") && buy.equals("")) {
            String result = "product updated error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
          log.debug(result);
        } else {
        String result = adm.product_update(id,name, sell, buy,qty,category);
        adm.loadProductTable("", dtm);

        if (result == "product updated succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "product updated error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
