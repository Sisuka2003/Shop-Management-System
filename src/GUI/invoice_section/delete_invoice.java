 ...
 * @author DELL
 */
public class delete_invoice extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(delete_invoice.class.getName());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (date.equals("") && pay.equals("") && customer.equals("")) {
            String result = "invoice deleted error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.invoice_delete(id);
            adm.loadInvoiceTable("", dtm);

            if (result == "invoice deleted successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "invoice deleted error") {
                fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (date.equals("") && pay.equals("") && customer.equals("")) {
            String result = "invoice Canceled error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.invoice_cancel(id);
            adm.loadInvoiceTable("", dtm);

            if (result == "invoice Canceled successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "invoice Canceled error") {
                fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_invoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_invoice().setVisible(true);
            }
        });
    }
