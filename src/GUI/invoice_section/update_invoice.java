 ...
 * @author DELL
 */
public class update_invoice extends javax.swing.JFrame {
   static Logger log = Logger.getLogger(update_invoice.class.getName());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String id = idField.getText();
        GUI.invoice_section.update_invoice_item iut = new GUI.invoice_section.update_invoice_item();
        adm.loadInvoiceItemTable(id, iut.dtm);
        iut.setVisible(true);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String s4 = adm.getCustomerID(String.valueOf(o4));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_invoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_invoice().setVisible(true);
            }
        });
    }
