 ...
 * @author DELL
 */
public class succese extends javax.swing.JDialog {
  static Logger log = Logger.getLogger(succese.class.getName());

    public Timer t;
    public ActionListener al;
    public succese(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        icon();
        initComponents();
  al = new ActionListener() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(succese.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                succese dialog = new succese(new javax.swing.JFrame(), true);
