 ...
 * @author DELL
 */
public class fails extends javax.swing.JDialog {

   static Logger log = Logger.getLogger(fails.class.getName());
    /**
     * Creates new form fails
     */
    public fails(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        icon();
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                fails dialog = new fails(new javax.swing.JFrame(), true);
        ...
        if(result =="attendance adding error"){
               try {
                       jLabel3.setText("Checked In Failed");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="Checking out error"){
               try {
                       jLabel3.setText("Checking Out Failed");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
    ...
    //Staff register,update and delete
        ...
        if(result =="error"){
               try {
                       jLabel3.setText("Sales Viewing Failed");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="Product Already Registered"){
               try {
                       jLabel3.setText("Product Already Registered");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="Unregistered product"){
               try {
                       jLabel3.setText("Unregistered Product");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="Invalid Product Barcode"){
               try {
                       jLabel3.setText("Barcode Already Taken");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="year"){
               try {
                       jLabel3.setText("Year Cannot Be Found");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="Profit / Loss Calculation error"){
               try {
                       jLabel3.setText("Profit / Loss Calculation Failed");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="invalid month"){
               try {
                       jLabel3.setText("Month Cannot be Found");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="product have"){
               try {
                       jLabel3.setText("Barcode Already Used");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
        ...
        if(result =="item updated Failed"){
               try {
                       jLabel3.setText("GRN Item Updation Failed");
                       this.dispose();
                    } catch (Exception e) {
                       e.printStackTrace();
                       log.debug(e.getMessage());
