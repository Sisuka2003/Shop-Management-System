 ...
 * @author DELL
 */
public class search_staff_payment extends javax.swing.JFrame {
static Logger log=Logger.getLogger(search_staff_payment.class.getName());
    DefaultTableModel dtm;
    staffPayment adm;
    public search_staff_payment() {
        icon();
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(240, 30, 310, 30);
        ...
        jButton2.setBounds(550, 30, 110, 30);
        ...
        statusField.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NAME", "DESIGNATION", "MONTH", "PAYMENT", "YEAR" }));
        ...
        statusField.setBounds(100, 30, 140, 30);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        }else if(attribute.equals("DESIGNATION")){
            adm.loadPaymentTableJob(keyword, dtm);
            jTextField2.setText("Please Enter The Job Name");
            jTextField2.setForeground(new Color(153,153,153));
        }else if(attribute.equals("MONTH")){
            adm.loadPaymentTableMonth(keyword, dtm);
            jTextField2.setText("Please Enter The Month");
            jTextField2.setForeground(new Color(153,153,153));
        }else if(attribute.equals("PAYMENT")){
            adm.loadPaymentTablePay(keyword, dtm);
            jTextField2.setText("Please Enter The Payment");
            jTextField2.setForeground(new Color(153,153,153));
        }else if(attribute.equals("YEAR")){
            adm.loadPaymentTableYear(keyword, dtm);
            jTextField2.setText("Please Enter The Year");
            jTextField2.setForeground(new Color(153,153,153));
        }
...
Object o =statusField.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_staff_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_staff_payment().setVisible(true);
            }
        });
    }
