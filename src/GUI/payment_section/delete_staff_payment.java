 ...
 * @author DELL
 */
public class delete_staff_payment extends javax.swing.JFrame {
static Logger log=Logger.getLogger(delete_staff_payment.class.getName());
    DefaultTableModel dtm;
    staffPayment adm;

    public delete_staff_payment() {
        icon();
        initComponents();
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(paymentField, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(id.equals("")){
        String result = "payment deleting error";
             fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.staff_payment_delete(id);
        adm.loadPaymentTable("", dtm);

        if (result == "payment deleted succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "payment deleting error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_staff_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_staff_payment().setVisible(true);
            }
        });
    }
