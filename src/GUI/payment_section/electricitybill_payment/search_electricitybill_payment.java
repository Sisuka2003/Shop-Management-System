 ...
 * @author DELL
 */
public class search_electricitybill_payment extends javax.swing.JFrame {
static  Logger log=Logger.getLogger(search_electricitybill_payment.class.getName());
    DefaultTableModel dtm;
    DefaultTableModel dtm2;
    DefaultTableModel dtm3;
    electricitybillPayment adm;

    public search_electricitybill_payment() {
        icon();
        initComponents();
        ...
        adm.loadElectricBillTableOnYear("", dtm);
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(monthField, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        endField.setBounds(310, 50, 230, 30);
        ...
        jButton2.setBounds(580, 50, 110, 30);
        ...
        startField.setBounds(40, 50, 230, 30);
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(270, 40, 40, 40);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        adm.loadElectricBillTableOnYear(text, dtm);
        monthField.setText("Please Enter The Payment Year");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String year = s1;
        String reportPath = "C:\\Users\\DELL\\JaspersoftWorkspace\\MyReports\\electricitybill.jrxml";
        ...
        try {
            ...
            GUI.reports.electricitybill r = new GUI.reports.electricitybill(this, rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(search_electricitybill_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new search_electricitybill_payment().setVisible(true);
            }
        });
    }
