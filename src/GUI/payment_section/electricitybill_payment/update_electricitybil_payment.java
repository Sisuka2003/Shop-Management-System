 ...
 * @author DELL
 */
public class update_electricitybil_payment extends javax.swing.JFrame {
static Logger log=Logger.getLogger(update_electricitybil_payment.class.getName());
    DefaultTableModel dtm;
    electricitybillPayment adm;
    public update_electricitybil_payment() {
        icon();
        initComponents();
    ...
    private void jButton6MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseEntered
        jButton6.setBackground(new Color(42,245,164));
        jButton6.setForeground(new Color(0, 0, 0));
    }//GEN-LAST:event_jButton6MouseEntered

    private void jButton6MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseExited
        jButton6.setBackground(new Color(0,255,153));
        jButton6.setForeground(new Color(0, 0, 0));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (id.equals("") && amount.equals("")) {
            String result = "electricitybill payment update fail";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.electricitybill_update(status,amount,id);
            adm.loadElectricBillTable("", dtm);

            if (result == "electricitybill Payment update successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "electricitybill payment update fail") {
            fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_electricitybil_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_electricitybil_payment().setVisible(true);
            }
        });
    }
