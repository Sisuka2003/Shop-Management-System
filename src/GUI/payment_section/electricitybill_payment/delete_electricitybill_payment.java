 ...
 * @author DELL
 */
public class delete_electricitybill_payment extends javax.swing.JFrame {
  static Logger log = Logger.getLogger(delete_electricitybill_payment.class.getName()); 
    DefaultTableModel dtm;
    electricitybillPayment adm;
    public delete_electricitybill_payment() {
        icon();
        initComponents();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id.equals("") && amount.equals("")) {
            String result = "electricity payment delete fail";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.electricitybill_delete(id);
            adm.loadElectricBillTable("", dtm);

            if (result == "electricity Payment deleted successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "electricity payment delete fail") {
            fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_electricitybill_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_electricitybill_payment().setVisible(true);
            }
        });
    }
