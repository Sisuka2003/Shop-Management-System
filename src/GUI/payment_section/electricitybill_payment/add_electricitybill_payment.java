 ...
 * @author DELL
 */
public class add_electricitybill_payment extends javax.swing.JFrame {
  static Logger log = Logger.getLogger(add_electricitybill_payment.class.getName());
    DefaultTableModel dtm;
    electricitybillPayment adm;
    public add_electricitybill_payment() {
        icon();
        initComponents();
        dtm=(DefaultTableModel)jTable1.getModel();
        adm=new electricitybillPayment();
        adm.loadElectricBillTable("",dtm);
        year();
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(yearField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel10, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(paymentField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(statusField1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id.equals("") && amount.equals("")) {
            String result = "electricitybill added fail";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.electricitybill_register(status,amount,year);
            adm.loadElectricBillTable("", dtm);

            if (result == "electricitybill added successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "electricitybill added fail") {
            fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
            log.debug(result);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adm.loadElectricBillTable(keyword, dtm);
        jTextField1.setText("Please Enter The Payment Month");
        jTextField1.setForeground(new Color(153,153,153));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Object o5 = jTable1.getValueAt(row, 2);
        String s5 = String.valueOf(o5);
        yearField.setText(s5);

        Object o6 = jTable1.getValueAt(row, 3);
        String s6 = String.valueOf(o6);
        paymentField.setText(s6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_electricitybill_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_electricitybill_payment().setVisible(true);
            }
        });
    }
