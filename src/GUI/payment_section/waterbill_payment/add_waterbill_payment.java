 ...
 * @author DELL
 */
public class add_waterbill_payment extends javax.swing.JFrame {
static Logger log=Logger.getLogger(add_waterbill_payment.class.getName());
    DefaultTableModel dtm;
    waterbillPayment adm;
    public add_waterbill_payment() {
        icon();
        initComponents();
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(statusField1, 0, 272, Short.MAX_VALUE)))))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id.equals("") && amount.equals("")) {
            ...
            String result = adm.waterbill_register(status,amount,year);
            adm.loadWaterBillTable("", dtm);

            if (result == "Waterbill added successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "waterbill added fail") {
            fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_waterbill_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new add_waterbill_payment().setVisible(true);
            }
        });
    }
