 ...
 * @author DELL
 */
public class update_waterbill_payment extends javax.swing.JFrame {
static Logger log=Logger.getLogger(update_waterbill_payment.class.getName());
    DefaultTableModel dtm;
    waterbillPayment adm;
    public update_waterbill_payment() {
        icon();
        initComponents();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      String status = null;
        ...
        if (id.equals("") && amount.equals("")) {
            ...
            String result = adm.waterbill_update(status,amount,id);
            adm.loadWaterBillTable("", dtm);

            if (result == "Waterbill Payment update successfully") {
                succese suceed = new succese(this,true);
                suceed.setVisible(true);
            } else if (result == "waterbill payment update fail") {
            fails f = new fails(this,true);
                f.popupstatus(result);
                f.setVisible(true);
            log.debug(result);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update_waterbill_payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new update_waterbill_payment().setVisible(true);
            }
        });
    }
