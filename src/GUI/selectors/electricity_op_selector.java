 ...
 * @author DELL
 */
public class electricity_op_selector extends javax.swing.JFrame {

    
    static Logger log = Logger.getLogger(electricity_op_selector.class.getName());
    /**
     * Creates new form electricity_op_selector
     */
    public electricity_op_selector() {
        icon();
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add_electricity.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update_electricity.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete_electricity.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/electricity.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       new GUI.payment_section.electricitybill_payment.add_electricitybill_payment().setVisible(true);
   ...
   new GUI.payment_section.electricitybill_payment.update_electricitybil_payment().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     new GUI.payment_section.electricitybill_payment.delete_electricitybill_payment().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.payment_section.electricitybill_payment.search_electricitybill_payment().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(electricity_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new electricity_op_selector().setVisible(true);
            }
        });
    }
