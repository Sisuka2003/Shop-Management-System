 ...
 * @author DELL
 */
public class catergory_stock_op_selector extends javax.swing.JFrame {

      static Logger log = Logger.getLogger(catergory_stock_op_selector.class.getName());
    /**
     * Creates new form category_stock_op_selector
     */
    public catergory_stock_op_selector() {
        icon();
        initComponents();
        Thread t1 = new Thread() {
            public void run() {
                for (int x = 210; x >= 60; x--) {
                    try {
                        int y = jButton1.getY();
                        Thread.sleep(1);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 146, 125));

        jButton2.setBackground(new java.awt.Color(255, 255, 255));
        jButton2.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update-stock.png"))); // NOI18N
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, 146, 125));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 90, 146, 125));
    ...
    new GUI.product_section.stock_section.add_stock().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      new GUI.product_section.stock_section.update_stock().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.product_section.stock_section.search_stock().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catergory_stock_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new catergory_stock_op_selector().setVisible(true);
            }
        });
    }
