 ...
 * @author DELL
 */
public class invoice_op_selector extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(invoice_op_selector.class.getName());
    /**
     * Creates new form invoice_op_selector
     */
    public invoice_op_selector() {
        icon();
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add_bill.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update_bill.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete_bill.png"))); // NOI18N
    ...
    new GUI.invoice_section.add_invoice().setVisible(true);
    ...
    new GUI.invoice_section.update_invoice().setVisible(true);
    ...
    new GUI.invoice_section.delete_invoice().setVisible(true);
    ...
    new GUI.invoice_section.search_invoice().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(invoice_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new invoice_op_selector().setVisible(true);
            }
        });
    }
