 ...
 * @author DELL
 */
public class staff_payment_op_selector extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(staff_payment_op_selector.class.getName());
    /**
     * Creates new form staff_payment_op_selector
     */
    public staff_payment_op_selector() {
        icon();
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GUI.payment_section.add_staff_payment().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new GUI.payment_section.update_staff_payment().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new GUI.payment_section.delete_staff_payment().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.payment_section.search_staff_payment().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staff_payment_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new staff_payment_op_selector().setVisible(true);
            }
        });
    }
