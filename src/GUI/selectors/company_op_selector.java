 ...
 * @author DELL
 */
public class company_op_selector extends javax.swing.JFrame {

      static Logger log = Logger.getLogger(company_op_selector.class.getName());
    /**
     * Creates new form company_op_selector
     */
    public company_op_selector() {
        icon();
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add-company.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update_company.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete-company.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/company-large.png"))); // NOI18N
   ...
   new GUI.supplier_section.company_section.add_company().setVisible(true);
    ...
    new GUI.supplier_section.company_section.update_company().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       new GUI.supplier_section.company_section.delete_company().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      new GUI.supplier_section.company_section.search_company().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(company_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new company_op_selector().setVisible(true);
            }
        });
    }
