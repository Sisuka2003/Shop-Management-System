 ...
 * @author DELL
 */
public class attendace_op_selector extends javax.swing.JFrame {

      static Logger log = Logger.getLogger(attendace_op_selector.class.getName());
    /**
     * Creates new form attendace_op_selector
     */
    public attendace_op_selector() {
        icon();
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add_attendance.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update_attendance.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete_attendance.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/calendar.png"))); // NOI18N
...
new GUI.staff_section.attendace_section.add_attendance().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      new GUI.staff_section.attendace_section.update_attendance().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     new GUI.staff_section.attendace_section.delete_attendance().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.staff_section.attendace_section.search_attendance().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(attendace_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new attendace_op_selector().setVisible(true);
            }
        });
    }
