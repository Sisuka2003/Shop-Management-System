 ...
 * @author DELL
 */
public class job_op_selector extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(job_op_selector.class.getName());
    /**
     * Creates new form job_op_selector
     */
    public job_op_selector() {
        icon();
        initComponents();  Thread t1 = new Thread() {
            public void run() {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add_role.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update_role.png"))); // NOI18N
        jButton2.setText("Update Role");
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete_role.png"))); // NOI18N
        jButton3.setText("Delete Role");
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/briefcase.png"))); // NOI18N
        jButton4.setText("View Role");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GUI.staff_section.job_roles.add_job().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new GUI.staff_section.job_roles.update_job().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new GUI.staff_section.job_roles.delete_job().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.staff_section.job_roles.search_job().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(job_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new job_op_selector().setVisible(true);
            }
        });
    }
