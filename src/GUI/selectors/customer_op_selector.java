 ...
 * @author DELL
 */
public class customer_op_selector extends javax.swing.JFrame {

      static Logger log = Logger.getLogger(customer_op_selector.class.getName());
    /**
     * Creates new form customer_op_selector
     */
    public customer_op_selector() {
        icon();
        initComponents();
    ...
    new GUI.customer_section.add_customer().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     new GUI.customer_section.update_customer().setVisible(true);
    ...
    new GUI.customer_section.delete_customer().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     new GUI.customer_section.search_customer().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customer_op_selector().setVisible(true);
            }
        });
    }
