 ...
 * @author DELL
 */
public class waterbill_op_selector extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(waterbill_op_selector.class.getName());
    /**
     * Creates new form waterbill_op_selector
     */
    public waterbill_op_selector() {
        icon();
        initComponents(); 
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add_water.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update_water.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete_water.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/drop.png"))); // NOI18N
   ...
   new GUI.payment_section.waterbill_payment.add_waterbill_payment().setVisible(true);
    ...
    new GUI.payment_section.waterbill_payment.update_waterbill_payment().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new GUI.payment_section.waterbill_payment.delete_waterbill_payment().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.payment_section.waterbill_payment.search_waterbill_payment().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(waterbill_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new waterbill_op_selector().setVisible(true);
            }
        });
    }
