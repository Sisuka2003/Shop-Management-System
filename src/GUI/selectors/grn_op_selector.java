 ...
 * @author DELL
 */
public class grn_op_selector extends javax.swing.JFrame {

    
    static Logger log = Logger.getLogger(grn_op_selector.class.getName());
    /**
     * Creates new form grn_op_selector
     */
    public grn_op_selector() {
        icon();
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GUI.supplier_section.grn_section.add_grn().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new GUI.supplier_section.grn_section.update_grn().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new GUI.supplier_section.grn_section.delete_grn().setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GUI.supplier_section.grn_section.search_grn().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grn_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new grn_op_selector().setVisible(true);
            }
        });
    }
