 ...
 * @author DELL
 */
public class po_op_selector extends javax.swing.JFrame {

    static Logger log = Logger.getLogger(po_op_selector.class.getName());
    /**
     * Creates new form po_op_selector
     */
    public po_op_selector() {
        icon();
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/add-po.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/update-po.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/delete-po.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/po.png"))); // NOI18N
    ...
    new GUI.purchase_order.add_order().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       new GUI.purchase_order.update_order().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     new GUI.purchase_order.delete_order().setVisible(true);
    ...
    new GUI.purchase_order.search_products_order().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(po_op_selector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new po_op_selector().setVisible(true);
            }
        });
    }
