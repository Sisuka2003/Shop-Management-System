...
public class deleteAdmin extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(deleteAdmin.class.getName());
    ...
    private void jButton4MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseEntered
        jButton4.setBackground(new Color(244, 93, 93));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (id.equals("")) {
            String result = "admin deleting error";
            fails f = new fails(this, true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        } else {
            String result = adm.admin_delete(id);
            adm.loadAdminTable("", dtm);

            if (result == "admin deleted succesfully") {
                succese suceed = new succese(this, true);
                suceed.setVisible(true);
            } else if (result == "admin deleting error") {
                fails f = new fails(this, true);
                f.popupstatus(result);
                f.setVisible(true);
                log.debug(result);
