...
public class add_admin extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(add_admin.class.getName());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(name.equals("") && pswd.equals("") && job.equals("")){
          String result="admin adding error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.admin_register(name, pswd, job);
        adm.loadAdminTable("", dtm);

        if (result == "admin added succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "admin adding error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTextField1.setText("Please Enter The Job Name");
        jTextField1.setForeground(new Color(153,153,153));
