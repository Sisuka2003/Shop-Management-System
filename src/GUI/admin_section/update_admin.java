 ...
 */
package GUI.admin_section;

import static GUI.admin_section.add_admin.log;
...
public class update_admin extends javax.swing.JFrame {
    ...
    static Logger log = Logger.getLogger(update_admin.class.getName());
    ...
    private void initComponents() {
        ...
        nameField.setText("Lanka Carvings");
        nameField.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        nameField.setFocusable(false);
        nameField.setOpaque(false);

        pswdField.setFont(new java.awt.Font("Segoe UI Semibold", 0, 13)); // NOI18N
        pswdField.setForeground(new java.awt.Color(255, 255, 255));
        pswdField.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pswdField, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36)
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTextField1.setText("Please Enter The Job Role");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ADMIN ID", "ADMIN USERNAME", "ADMIN PASSWORD", "JOB ROLE"
            }
        ) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String job = jobField.getText();
           ...
           if(pswd.equals("") && job.equals("") && id.equals("")){
          String result="admin updating error";
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
        }else{
        String result = adm.admin_update(id, name, pswd, job);
        adm.loadAdminTable("", dtm);

        if (result == "admin updated succesfully") {
            succese suceed = new succese(this,true);
            suceed.setVisible(true);
        } else if (result == "admin updating error") {
            fails f = new fails(this,true);
            f.popupstatus(result);
            f.setVisible(true);
            log.debug(result);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adm.loadAdminTable(keyword, dtm);
        jTextField1.setText("Please Enter The Job Role");
        jTextField1.setForeground(new Color(153,153,153));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        pswdField.setText(s3);

        Object o4 = jTable1.getValueAt(row, 3);

        String result = adm.getJobId(String.valueOf(o4));
