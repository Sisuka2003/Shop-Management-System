 ...
 * @author DELL
 */
public class supports extends javax.swing.JDialog {

    /**
     * Creates new form supports
     */
    public supports(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        icon();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("contactreygren@gmail.com");

        jLabel12.setFont(new java.awt.Font("Segoe UI Semilight", 0, 11)); // NOI18N
        jLabel12.setText("S/G2 Park Road, Colombo 05");
        ...
        jLabel9.setText("Reygren (PVT) .LTD");
        ...
        jLabel3.setText("Reygren");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 240, 250));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                supports dialog = new supports(new javax.swing.JFrame(), true);
